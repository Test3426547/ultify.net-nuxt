      ...
      <div class="flex flex-col lg:flex-row justify-between items-start space-y-8 lg:space-y-0 lg:space-x-12">
        ...
        <div class="w-full lg:w-1/3">
          <div class="space-y-5">
            <button 
              ...
              :class="[
                'w-full py-4 px-6 rounded-full border-2 transition-colors duration-300 text-lg font-bold',
        ...
        <div class="w-full lg:w-1/2">
          <form @submit.prevent="submitForm" class="space-y-5">
            <div>
              <input type="text" id="name" v-model="form.name" placeholder="Name" class="w-full px-6 py-4 rounded-full border-2 border-white bg-white text-ultify-dark-grey placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-ultify-blue text-base">
            </div>
            <div>
              <input type="email" id="email" v-model="form.email" placeholder="Email" class="w-full px-6 py-4 rounded-full border-2 border-white bg-white text-ultify-dark-grey placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-ultify-blue text-base">
            </div>
            <div>
