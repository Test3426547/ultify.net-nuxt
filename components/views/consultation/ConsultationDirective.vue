<template>
  <div class="bg-ultify-grey py-8 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
      <div class="bg-white rounded-3xl shadow-lg overflow-hidden">
        <div class="px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-10">
          <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between">
            <div class="mb-4 sm:mb-0 sm:mr-6">
              <span class="inline-block px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-medium bg-emerald-500 text-white whitespace-nowrap">
