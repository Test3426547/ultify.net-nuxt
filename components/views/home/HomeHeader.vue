<template>
  <header class="relative min-h-screen overflow-hidden" v-if="headerData">
    <div class="absolute inset-0 bg-white h-2/5 md:h-1/2"></div>
    <div class="absolute inset-x-0 bottom-0 bg-emerald-500 h-3/5 md:h-1/2"></div>
      ...
      <div class="flex flex-col lg:flex-row h-full">
        <div class="w-full lg:w-7/12 flex flex-col py-5 relative">
          ...
          <div class="lg:absolute lg:bottom-1/4 lg:-left-[120px] lg:right-0 z-10 px-4 lg:px-0 mt-8 lg:mt-0">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-4 max-w-3xl">
              <NuxtLink 
    ...
    <svg class="absolute bottom-5 left-1/2 transform -translate-x-1/2 animate-bounce hidden lg:block" width="40" height="35" viewBox="0 0 40 35" fill="none" xmlns="http://www.w3.org/2000/svg">
