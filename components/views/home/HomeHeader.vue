  ...
  <header class="relative min-h-screen overflow-hidden" v-if="headerData">
    ...
    <div class="container mx-auto h-full px-4 sm:px-6 xl:px-8 flex flex-col xl:flex-row items-center justify-between">
      <div class="w-full xl:w-1/2 flex flex-col py-5 relative">
        <div class="xl:absolute xl:top-0 z-10 mb-8 xl:mb-0 flex flex-col justify-center items-center xl:items-start h-[30vh] sm:h-[40vh] xl:h-auto">
        ...
        <div class="xl:absolute xl:bottom-0 z-10 mt-8 xl:mt-0 flex flex-col justify-center items-center xl:items-start h-[50vh] sm:h-[60vh] xl:h-auto">
